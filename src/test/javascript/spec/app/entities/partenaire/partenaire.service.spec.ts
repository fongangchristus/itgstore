...
describe('Service Tests', () => {
    describe('Partenaire Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Partenaire(0, 0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should update a Partenaire', async () => {
                const returnedFromService = Object.assign(
                    {
                        code: 1,
                        libelle: 'BBBBBB'
            ...
            it('should return a list of Partenaire', async () => {
                const returnedFromService = Object.assign(
                    {
                        code: 1,
                        libelle: 'BBBBBB'
            ...
            it('should delete a Partenaire', async () => {
